...
export default class ModernCalendarWebPart extends BaseClientSideWebPart<IModernCalendarWebPartProps> {
  ...
  public constructor() {
    ...
    //SPComponentLoader.loadCss('C:/Projects/SPfxPortalApp1/node_modules/sweetalert2/dist/sweetalert2.min.css');
    //gulpSPComponentLoader.loadCss('C:/Projects/SPfxPortalApp1/node_modules/fullcalendar/dist/fullcalendar.min.css');    
  }
  ...
  protected getPropertyPaneConfiguration(): IPropertyPaneConfiguration {
    ...
    return {
      pages: [
        {
          header: {
            description: 'PropertyPaneDescription', //strings.PropertyPaneDescription
          },
          groups: [
            {
              groupName: 'BasicGroupName',//strings.BasicGroupName,
              groupFields: [
                PropertyPaneTextField('description', {
                  label: 'DescriptionFieldLabel'//strings.DescriptionFieldLabel
                }),
